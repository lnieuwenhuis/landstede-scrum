    ...
    <div class="flex-1">
        <div class="bg-white p-4 shadow-md rounded-lg overflow-hidden">
            ...
            <button 
                ...
                class="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center gap-2 mr-2 max-h-12 min-w-max"
            >
