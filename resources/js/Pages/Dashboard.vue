                            ...
                            <div v-for="group in groups" :key="group.id" 
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div>
                                        ...
                                        <button @click="toggleDeleteConfirmation(group.id)">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-6 text-red-500 hover:text-red-700" viewBox="0 0 20 20" fill="currentColor">
