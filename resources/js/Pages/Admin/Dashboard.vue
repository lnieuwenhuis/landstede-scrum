                                ...
                                <div v-for="board in boards" :key="board.id" 
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex flex-col space-y-2">
                                            ...
                                            <button @click="toggleDeleteConfirmation(board.id)" class="px-3 py-1.5 text-sm sm:px-4 sm:py-2 sm:text-base bg-red-500 hover:bg-red-700 rounded-lg text-center">
